...
public class TelaCadastro extends JFrame {
	...
	public static JTextField txtDataNasc;
	...
	public TelaCadastro() {
		...
		btnSalvar.addActionListener(new ActionListener() {
			...
			String d = null;
				...
				banco.conectar();
				banco.inserirCliente(datasq2, txtNome, txtCpf, d, datasql, txtCep, txtRua, txtNum, txtBairro, txtCidade, txtUf, txtComp, txtTel, txtCel, txtEmail);
		...
		btnSalvar.setBounds(795, 474, 97, 63);
		...
		btnVoltar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				BancoDeDados banco = new BancoDeDados();
				banco.conectar();
				//banco.clienteAnimal(listName, txtDono, txtCliente);;
				banco.desconectar();
				animal.setVisible(true);
			}
		});
		btnVoltar.setBounds(645, 474, 126, 25);
		...
		panel_2.add(txtData);
				...
				btnEditar.setBounds(375, 477, 97, 25);
				panel.add(btnEditar);
		...
		btnApagar.setBounds(645, 512, 97, 25);

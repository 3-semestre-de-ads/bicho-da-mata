...
public class TelaFornecedor extends JFrame {
	...
	public TelaFornecedor() {
		...
		btnEditar.setBounds(386, 159, 97, 25);
		panel.add(btnEditar);
		...
		btnExcluir.setBounds(694, 497, 97, 25);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (resposta == JOptionPane.YES_OPTION) {
						...
						banco.conectar();
						banco.inserirContato(datasql, txtNome, txtCnpj, txtContato, txtTelefone, txtEmail, txtDescricao);
						txtNome.setText("");
						txtCnpj.setText("");
						txtContato.setText("");
						txtTelefone.setText("");
		...
		tbnSalvar.setBounds(834, 478, 97, 63);

...
public class TelaCalculadora extends JFrame {
	...
	public TelaCalculadora() {
		...
		JComboBox<Object> cbxUnidadeDose = new JComboBox<Object>();
		cbxUnidadeDose.setModel(new DefaultComboBoxModel<Object>(new String[] {"Mg", "Mcg"}));
		...
		JComboBox<Object> cbxUnidadeConcentracao = new JComboBox<Object>();
		cbxUnidadeConcentracao.setModel(new DefaultComboBoxModel<Object>(new String[] {"G", "Mg", "Mcg", "%"}));

...
public class BancoDeDados {
	...
	public void verificarCnpj(String cnpj) {
		try {
			String query = "SELECT cnpj from fornecedor ORDER by cnpj";
	...
	public void inserirContato(String nome, String cnpj, String contato, String telefone, String descricao) {
		try {
			String query = "INSERT INTO fornecedor (nome , cnpj, contato, telefone, descricao) VALUES ('" + nome + "','" + cnpj + "','" + contato + "','" + telefone + "','" + descricao + "');";
			this.statement.executeUpdate(query);
		}catch (Exception e) {
